...
source("Multiple Biomarkers project/Rand_hierarchy_constrRand_functions.R")
source("Multiple Biomarkers project/operational_characteristics_rand_hier_constRand.R")
source("Multiple Biomarkers project/simulation_scenarios_multipleBiomarkers.R")
...
# Save results 
saveRDS(mbiomarker_results, "Multiple Biomarkers project/results/mbiomarker_results")

###########################################################################################################################

# Export simulation results to excel worksheet

setwd("Multiple Biomarkers project/results")

# load results
mbiomarker_results  <- readRDS("Multiple Biomarkers project/results/mbiomarker_results")
